...
#else
#define RGB555toRGB24(t) t
#define RGB555toRGB241(t) ( (((t)&0x1f)<<19) | (((t)&0x3e0)<<6) | (((t)&0x7c00)>>7)|0xff000000 )
#endif
/*65816*/
typedef union {
    unsigned short w;
...
uint32_t *native_bitmap_pointer(int x, int y) __attribute__((used));

void native_bitmap_clear_line(int line, uint32_t);
...
uint32_t *native_set_joypad_state(uint32_t state) __attribute__((used));
