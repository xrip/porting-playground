...
static opcode_handler_struct m68k_opcode_handler_table[] =
{
    ...
    { m68k_op_bhi_8, 0xff00, 0x6200, { 8 } },
    { m68k_op_bls_8, 0xff00, 0x6300, { 8 } },
    { m68k_op_bcc_8, 0xff00, 0x6400, { 8 } },
    { m68k_op_bcs_8, 0xff00, 0x6500, { 8 } },
    { m68k_op_bne_8, 0xff00, 0x6600, { 8 } },
    { m68k_op_beq_8, 0xff00, 0x6700, { 8 } },
    { m68k_op_bvc_8, 0xff00, 0x6800, { 8 } },
    { m68k_op_bvs_8, 0xff00, 0x6900, { 8 } },
    { m68k_op_bpl_8, 0xff00, 0x6a00, { 8 } },
    { m68k_op_bmi_8, 0xff00, 0x6b00, { 8 } },
    { m68k_op_bge_8, 0xff00, 0x6c00, { 8 } },
    { m68k_op_blt_8, 0xff00, 0x6d00, { 8 } },
    { m68k_op_bgt_8, 0xff00, 0x6e00, { 8 } },
    { m68k_op_ble_8, 0xff00, 0x6f00, { 8 } },
    ...
    { m68k_op_pea_32_ai, 0xfff8, 0x4850, { 10 } },
    { m68k_op_pea_32_di, 0xfff8, 0x4868, { 16 } },
    { m68k_op_pea_32_ix, 0xfff8, 0x4870, { 20 } },
    { m68k_op_ext_16, 0xfff8, 0x4880, { 4 } },
    { m68k_op_movem_16_re_ai, 0xfff8, 0x4890, { 12 } },
    { m68k_op_movem_16_re_pd, 0xfff8, 0x48a0, { 8 } },
    { m68k_op_movem_16_re_di, 0xfff8, 0x48a8, { 16 } },
    { m68k_op_movem_16_re_ix, 0xfff8, 0x48b0, { 18 } },
    { m68k_op_ext_32, 0xfff8, 0x48c0, { 4 } },
    { m68k_op_movem_32_re_ai, 0xfff8, 0x48d0, { 16 } },
    { m68k_op_movem_32_re_pd, 0xfff8, 0x48e0, { 8 } },
    { m68k_op_movem_32_re_di, 0xfff8, 0x48e8, { 20 } },
    { m68k_op_movem_32_re_ix, 0xfff8, 0x48f0, { 22 } },
    ...
    { m68k_op_movem_16_er_ai, 0xfff8, 0x4c90, { 16 } },
    { m68k_op_movem_16_er_pi, 0xfff8, 0x4c98, { 12 } },
    { m68k_op_movem_16_er_di, 0xfff8, 0x4ca8, { 20 } },
    { m68k_op_movem_16_er_ix, 0xfff8, 0x4cb0, { 22 } },
    { m68k_op_movem_32_er_ai, 0xfff8, 0x4cd0, { 20 } },
    { m68k_op_movem_32_er_pi, 0xfff8, 0x4cd8, { 12 } },
    { m68k_op_movem_32_er_di, 0xfff8, 0x4ce8, { 24 } },
    { m68k_op_movem_32_er_ix, 0xfff8, 0x4cf0, { 26 } },
    ...
    { m68k_op_jmp_32_ix, 0xfff8, 0x4ef0, { 12 } },
    ...
    { m68k_op_dbf_16, 0xfff8, 0x51c8, { 14 } },
    ...
    { m68k_op_movem_16_re_aw, 0xffff, 0x48b8, { 16 } },
    { m68k_op_movem_16_re_al, 0xffff, 0x48b9, { 20 } },
    { m68k_op_movem_32_re_aw, 0xffff, 0x48f8, { 20 } },
    { m68k_op_movem_32_re_al, 0xffff, 0x48f9, { 24 } },
    ...
    { m68k_op_movem_16_er_aw, 0xffff, 0x4cb8, { 20 } },
    { m68k_op_movem_16_er_al, 0xffff, 0x4cb9, { 24 } },
    { m68k_op_movem_16_er_pcdi, 0xffff, 0x4cba, { 20 } },
    { m68k_op_movem_16_er_pcix, 0xffff, 0x4cbb, { 22 } },
    { m68k_op_movem_32_er_aw, 0xffff, 0x4cf8, { 24 } },
    { m68k_op_movem_32_er_al, 0xffff, 0x4cf9, { 28 } },
    { m68k_op_movem_32_er_pcdi, 0xffff, 0x4cfa, { 24 } },
    { m68k_op_movem_32_er_pcix, 0xffff, 0x4cfb, { 26 } },
...
void m68ki_build_opcode_table(void) {
    ...
    while (ostruct->mask != 0xff00) {
        for (i = 0; i < 0x10000; i++) {
            if ((i & ostruct->mask) == ostruct->match) {
                ...
                m68ki_cycles[i] = ostruct->cycles[0] * 1;
            }
        }
        ostruct++;
    }
    while (ostruct->mask == 0xff00) {
        for (i = 0; i <= 0xff; i++) {
            ...
            m68ki_cycles[ostruct->match | i] = ostruct->cycles[0] * 1;
        }
        ostruct++;
    }
    while (ostruct->mask == 0xf1f8) {
        for (i = 0; i < 8; i++) {
            for (j = 0; j < 8; j++) {
                ...
                m68ki_cycles[instr] = ostruct->cycles[0] * 1;
    ...
    while (ostruct->mask == 0xf1ff) {
        for (i = 0; i <= 0x07; i++) {
            ...
            m68ki_cycles[ostruct->match | (i << 9)] = ostruct->cycles[0] * 1;
        }
        ostruct++;
    }
    ...
    while (ostruct->mask == 0xffff) {
        ...
        m68ki_cycles[ostruct->match] = ostruct->cycles[0] * 1;
        ostruct++;
    }
#endif
}
